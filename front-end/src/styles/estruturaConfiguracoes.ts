export const settingsLayoutStyles = {
  ...
  nav:
    'sticky top-[calc(106px+env(safe-area-inset-top))] col-start-1 row-start-2 grid gap-[9px] rounded-[22px] border border-[var(--liquid-border)] p-2.5 shadow-[0_22px_64px_color-mix(in_srgb,var(--shadow),transparent_82%)] [background:linear-gradient(135deg,var(--liquid-highlight),transparent_56%),color-mix(in_srgb,var(--liquid-panel-soft),transparent_5%)] [backdrop-filter:blur(28px)_saturate(150%)] platform-windows:shadow-none platform-windows:[backdrop-filter:none] max-[860px]:static max-[860px]:col-start-1 max-[860px]:row-start-2 max-[860px]:grid max-[860px]:grid-cols-3 max-[860px]:gap-1.5 max-[560px]:grid-cols-3 platform-ios:!rounded-[18px] platform-ios:!bg-[var(--surface)] platform-ios:!shadow-none platform-ios:![backdrop-filter:none]',
  navButton:
    'group grid min-h-16 cursor-pointer grid-cols-[34px_minmax(0,1fr)] items-center gap-2.5 rounded-[15px] border border-transparent bg-transparent px-2.5 py-2 text-left text-buds-muted transition-[background,border-color,color,transform] duration-160 hover:-translate-y-px hover:border-[color-mix(in_srgb,var(--liquid-border),var(--accent)_36%)] hover:bg-[color-mix(in_srgb,var(--liquid-panel),var(--accent)_10%)] hover:text-buds-text platform-windows:transition-none platform-windows:hover:translate-y-0 max-[860px]:min-w-0 max-[860px]:grid-cols-1 max-[860px]:place-items-center max-[860px]:gap-1 max-[860px]:px-1 max-[860px]:py-2 max-[860px]:text-center',
  navButtonActive:
