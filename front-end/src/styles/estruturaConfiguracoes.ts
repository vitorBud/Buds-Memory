export const settingsLayoutStyles = {
  ...
  nav:
    'sticky top-[calc(106px+env(safe-area-inset-top))] col-start-1 row-start-2 grid gap-[9px] rounded-[22px] border border-[var(--liquid-border)] p-2.5 shadow-[0_22px_64px_color-mix(in_srgb,var(--shadow),transparent_82%)] [background:linear-gradient(135deg,var(--liquid-highlight),transparent_56%),color-mix(in_srgb,var(--liquid-panel-soft),transparent_5%)] [backdrop-filter:blur(28px)_saturate(150%)] platform-windows:shadow-none platform-windows:[backdrop-filter:none] max-[860px]:static max-[860px]:col-start-1 max-[860px]:row-start-2 max-[860px]:grid max-[860px]:grid-cols-3 max-[860px]:gap-1 max-[860px]:p-1.5 max-[560px]:grid-cols-3 platform-ios:!rounded-[18px] platform-ios:!bg-[var(--surface)] platform-ios:!shadow-none platform-ios:![backdrop-filter:none]',
  navButton:
  ...
  content:
    'col-start-2 row-start-2 grid min-w-0 w-full max-w-[920px] scroll-mt-3 content-start gap-4 [&>.settings-section]:hidden [&>.settings-section]:flex-col [&>.settings-section]:gap-[18px] [&>.settings-section]:overflow-hidden [&>.settings-section]:rounded-[22px] [&>.settings-section]:border [&>.settings-section]:border-[var(--liquid-border)] [&>.settings-section]:p-[clamp(18px,2.3vw,26px)] [&>.settings-section]:[background:linear-gradient(135deg,var(--liquid-highlight),transparent_52%),color-mix(in_srgb,var(--liquid-panel-soft),transparent_4%)] [&>.settings-section]:shadow-[0_22px_64px_color-mix(in_srgb,var(--shadow),transparent_78%)] [&>.settings-section]:m-0 [&>.settings-section]:min-h-[440px] [&>.settings-section]:w-full [&>.settings-section]:max-w-none max-[860px]:col-start-1 max-[860px]:row-start-3 max-[860px]:max-w-none max-[860px]:scroll-mt-[calc(12px+env(safe-area-inset-top))] max-[860px]:[&>.settings-section]:min-h-0',
} as const
