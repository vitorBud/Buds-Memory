export const navigationStyles = {
  ...
  floating:
    'fixed top-3.5 left-1/2 z-[120] w-max -translate-x-1/2 max-[900px]:top-2 max-[900px]:mt-2.5 max-[760px]:!top-auto max-[760px]:!right-5 max-[760px]:!bottom-[calc(14px+env(safe-area-inset-bottom))] max-[760px]:!left-5 max-[760px]:z-[5000] max-[760px]:!mx-auto max-[760px]:!grid max-[760px]:!min-h-[52px] max-[760px]:!w-auto max-[760px]:!max-w-[420px] max-[760px]:!translate-x-0 max-[760px]:!grid-cols-5 max-[760px]:!p-1',
  button:
