export const navigationStyles = {
  ...
  floating:
    'fixed top-3.5 left-1/2 z-[7000] w-max -translate-x-1/2 max-[900px]:top-2 max-[900px]:mt-2.5 max-[760px]:!top-auto max-[760px]:!right-5 max-[760px]:!bottom-[calc(14px+env(safe-area-inset-bottom))] max-[760px]:!left-5 max-[760px]:z-[7000] max-[760px]:!mx-auto max-[760px]:!grid max-[760px]:!min-h-[52px] max-[760px]:!w-auto max-[760px]:!max-w-[420px] max-[760px]:!translate-x-0 max-[760px]:!grid-cols-5 max-[760px]:!p-1',
  button:
    'inline-flex min-h-[34px] cursor-pointer items-center justify-center gap-1.5 whitespace-nowrap rounded-full border border-transparent bg-transparent px-[13px] text-xs text-aether-icon transition-[background,border-color,color,transform,box-shadow] duration-180 hover:-translate-y-px hover:border-[var(--liquid-border-strong)] hover:bg-[rgba(var(--accent-hot-rgb)/0.11)] hover:text-aether-text hover:shadow-[0_10px_34px_rgba(var(--accent-hot-rgb)/0.12)] platform-windows:transition-none max-[760px]:relative max-[760px]:z-[1] max-[760px]:!min-h-[42px] max-[760px]:min-w-0 max-[760px]:gap-[3px] max-[760px]:rounded-[19px] max-[760px]:!p-0 max-[760px]:[&>svg]:size-[18px] max-[760px]:[&>span]:hidden',
  active:
    '-translate-y-px border-transparent !bg-aether-action !text-aether-action-ink shadow-[0_10px_30px_rgba(var(--accent-hot-rgb)/0.2)] hover:!bg-aether-action hover:!text-aether-action-ink',
  desktopOnly:
    'max-[760px]:hidden',
} as const
