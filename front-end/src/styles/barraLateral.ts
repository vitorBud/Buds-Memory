export const sidebarStyles = {
  ...
  newChat:
    'relative inline-flex min-h-[38px] w-full items-center justify-center gap-2 overflow-hidden rounded-full border border-[var(--liquid-border)] bg-[var(--liquid-panel-soft)] px-3 text-aether-text transition-[background,border-color,color,transform,box-shadow] duration-180 hover:-translate-y-px hover:border-[var(--liquid-border-strong)] hover:bg-[rgba(var(--accent-hot-rgb)/0.11)] hover:shadow-[0_10px_34px_rgba(var(--accent-hot-rgb)/0.12)] max-[1180px]:w-10 max-[1180px]:[&>span]:hidden max-[760px]:!min-h-[46px] max-[760px]:!w-full max-[760px]:!animate-[sidebar-new-chat-in_420ms_cubic-bezier(0.22,1,0.36,1)_120ms_both] max-[760px]:!justify-center max-[760px]:!gap-[9px] max-[760px]:!rounded-[15px] max-[760px]:!border-transparent max-[760px]:!bg-aether-action max-[760px]:!text-aether-action-ink max-[760px]:!shadow-[0_10px_28px_rgba(var(--accent-hot-rgb)/0.24)] max-[760px]:text-sm max-[760px]:font-extrabold max-[760px]:[&>svg]:size-[18px] max-[760px]:[&>span]:!block platform-windows:animate-none',
  search:
