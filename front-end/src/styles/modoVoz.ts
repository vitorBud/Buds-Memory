export const voiceModeStyles = {
  root:
    'relative isolate grid h-screen min-h-[720px] items-center justify-items-center overflow-hidden px-6 pt-[clamp(84px,10vh,120px)] pb-11 [grid-template-rows:minmax(0,1fr)_auto_auto_auto_minmax(0,1fr)] [background:radial-gradient(circle_at_50%_42%,color-mix(in_srgb,var(--voice-a)_20%,transparent),transparent_30%),radial-gradient(circle_at_50%_50%,color-mix(in_srgb,var(--voice-b)_12%,transparent),transparent_48%),linear-gradient(180deg,var(--bg),color-mix(in_srgb,var(--bg)_88%,#000_12%))] platform-windows:[&_*]:![animation:none] platform-windows:[&_*]:![backdrop-filter:none] platform-windows:[&_*]:![transition-duration:0ms] min-[761px]:min-h-screen min-[761px]:pb-16 max-[760px]:!h-svh max-[760px]:!min-h-svh max-[760px]:!place-items-center max-[760px]:!content-center max-[760px]:!justify-center max-[760px]:!overflow-hidden max-[760px]:!px-3.5 max-[760px]:!pt-[calc(18px+env(safe-area-inset-top))] max-[760px]:!pb-[calc(128px+env(safe-area-inset-bottom))]',
  ambient:
  ...
  core:
    'row-start-2 grid size-[var(--core-size)] cursor-pointer appearance-none place-items-center border-0 bg-transparent p-0 [--core-size:clamp(248px,34vw,420px)] [-webkit-tap-highlight-color:transparent] transition-[opacity,transform] duration-250 hover:scale-[1.018] disabled:cursor-default disabled:opacity-90 disabled:hover:scale-100 platform-windows:transition-none platform-windows:hover:scale-100 max-[760px]:mx-auto max-[760px]:![--core-size:min(68vw,292px)]',
  coreLayer:
  ...
  status:
    'row-start-3 mt-7 grid min-h-14 items-center justify-items-center gap-1.5 text-center max-[760px]:mt-[18px] max-[760px]:min-h-[52px] max-[760px]:max-w-[min(330px,calc(100vw-28px))] [&>strong]:text-[clamp(24px,3vw,34px)] [&>strong]:font-semibold [&>strong]:tracking-normal [&>strong]:text-aether-text max-[760px]:[&>strong]:text-[clamp(22px,7vw,30px)] [&>span]:text-xs [&>span]:font-bold [&>span]:uppercase [&>span]:tracking-[0.12em] [&>span]:text-aether-muted max-[760px]:[&>span]:max-w-[280px] max-[760px]:[&>span]:text-[11px] max-[760px]:[&>span]:leading-[1.35] max-[760px]:[&>span]:tracking-[0.08em]',
  controls:
    'row-start-4 mt-[18px] flex max-w-[min(92vw,760px)] items-center gap-2.5 rounded-3xl border border-[color-mix(in_srgb,var(--voice-c)_16%,transparent)] p-2 shadow-[0_18px_50px_rgba(0,0,0,0.18),inset_0_1px_0_rgba(255,255,255,0.12)] [background:linear-gradient(135deg,rgba(255,255,255,0.15),rgba(255,255,255,0.035)),color-mix(in_srgb,var(--glass)_72%,transparent)] [backdrop-filter:blur(20px)_saturate(1.28)] platform-windows:shadow-none platform-windows:[backdrop-filter:none] max-[760px]:mt-3 max-[760px]:w-full max-[760px]:max-w-[min(360px,calc(100vw-28px))] max-[760px]:flex-col max-[760px]:items-stretch max-[760px]:gap-2 max-[760px]:rounded-[20px]',
  selectWrap:
  ...
  select:
    'w-full min-w-0 appearance-none border-0 bg-transparent text-xs font-bold text-aether-text outline-none [&>option]:text-slate-900',
  sensitivity:
  ...
  sensitivityButton:
    'inline-flex min-h-[30px] cursor-pointer appearance-none items-center gap-[7px] rounded-[14px] border-0 bg-transparent px-[11px] text-[11px] font-extrabold text-aether-muted transition-[background,color,transform] duration-180 hover:-translate-y-px hover:text-aether-text platform-windows:transition-none platform-windows:hover:translate-y-0 max-[760px]:w-full max-[760px]:min-w-0 max-[760px]:justify-center max-[760px]:px-2',
  sensitivityActive:
    'bg-[color-mix(in_srgb,var(--voice-a)_22%,rgba(255,255,255,0.1))] text-aether-text shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]',
  interrupt:
    ...
    'fixed bottom-[34px] z-20 inline-flex min-h-11 items-center gap-[9px] rounded-full border border-white/14 px-[18px] text-aether-text shadow-[0_18px_48px_rgba(0,0,0,0.28)] transition-[transform,background] duration-200 [background:linear-gradient(135deg,rgba(255,255,255,0.14),transparent_48%),rgba(255,255,255,0.07)] [backdrop-filter:blur(18px)_saturate(1.35)] hover:bg-rose-500/18 platform-windows:shadow-none platform-windows:transition-none platform-windows:[backdrop-filter:none] min-[761px]:left-1/2 min-[761px]:-translate-x-1/2 min-[761px]:hover:[transform:translateX(-50%)_translateY(-1px)] max-[760px]:!right-auto max-[760px]:!bottom-[calc(14px+env(safe-area-inset-bottom))] max-[760px]:!left-1/2 max-[760px]:z-[5100] max-[760px]:min-h-[42px] max-[760px]:max-w-[calc(100vw-32px)] max-[760px]:-translate-x-1/2 max-[760px]:whitespace-nowrap max-[760px]:px-3.5 max-[760px]:hover:-translate-x-1/2 max-[760px]:[&>span]:overflow-hidden max-[760px]:[&>span]:text-ellipsis max-[760px]:[&>span]:text-[13px]',
  micIndicator:
